...
with app.app_context():
    ...
    for employee in employees:
        ...
        employee_skill = EmployeeSkill(employee_num=employee.employee_num, skill_id=random.choice([1, 2, 3]), level=skill_level)
        db.session.add(employee_skill)
        
        qualification_id = random.choice([1, 2, 3])
        ...
        training_id = random.choice([1, 2, 3])
    ...
    pending_skill1 = PendingSkill(employee_num=1, skill_name='Python', level=2, submitted_date=date(2023, 5, 1))
    pending_skill2 = PendingSkill(employee_num=2, skill_name='Data Analysis', level=1, submitted_date=date(2023, 5, 2))

    pending_qual1 = PendingQualification(employee_num=1, qualification_name='PMP', newacq_renewal='new', acq_renew_date=date(2023, 4, 1), expiry_date=date(2026, 4, 1))
    pending_qual2 = PendingQualification(employee_num=2, qualification_name='AWS Certified', newacq_renewal='renewal', acq_renew_date=date(2023, 4, 15), expiry_date=date(2026, 4, 15))

    pending_training1 = PendingTraining(employee_num=1, training_name='Leadership Training', start_date=date(2023, 6, 1), end_date=date(2023, 6, 5))
    pending_training2 = PendingTraining(employee_num=2, training_name='Technical Writing', start_date=date(2023, 7, 10), end_date=date(2023, 7, 15))
    ...
    registration_history1 = RegistrationHistory(employee_num=1, action_type='Skill', action_detail='Python Level 2', status='申請中', date=date(2023, 5, 1))
    registration_history2 = RegistrationHistory(employee_num=2, action_type='Skill', action_detail='Data Analysis Level 1', status='申請中', date=date(2023, 5, 2))
    registration_history3 = RegistrationHistory(employee_num=1, action_type='Qualification', action_detail='PMP', status='申請中', date=date(2023, 4, 1))
    registration_history4 = RegistrationHistory(employee_num=2, action_type='Qualification', action_detail='AWS Certified', status='申請中', date=date(2023, 4, 15))
    registration_history5 = RegistrationHistory(employee_num=1, action_type='Training', action_detail='Leadership Training', status='申請中', date=date(2023, 6, 1))
    registration_history6 = RegistrationHistory(employee_num=2, action_type='Training', action_detail='Technical Writing', status='申請中', date=date(2023, 7, 10))
